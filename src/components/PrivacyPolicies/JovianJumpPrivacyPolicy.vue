<template>
  <Card class="JovianJumpPrivacyPolicy">
    <strong>Privacy Policy</strong>
    <p>
      This privacy policy applies to the Jovian Jump app (hereby referred to as
      "Application") for mobile devices that was created by Daniel Intriligator
      (hereby referred to as "Service Provider") as a Free service. This service
    ...
    <p>
      ...
      please contact them at DIntriligator@gmail.com and they will respond in a
      reasonable time.
    </p>
    ...
    <div>
      ...
      <p>
        ...
        Service Provider (DIntriligator@gmail.com) so that they will be able to
    ...
    <br />
    <p>This privacy policy is effective as of 2026-01-20</p>
    ...
    <p>
      ...
      via email at DIntriligator@gmail.com.
    </p>
    <hr />
    <p>
